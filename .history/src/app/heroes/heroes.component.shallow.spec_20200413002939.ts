...
describe("Heroes Componet (complex shallow test)", () => {
  ...
  Errors:
    ...
    remove the [NO_ERRORS_SCHEMA] & inject a mocked component.
      ...
      you can deletet the methods. delete styleUrls, replace templateUrl with template containing div tags.
  ...
  */
  ...
  //dealing with lists inside template
  it("should create one li for each hero", () => {
    mockHeroService.getHeroes.and.returnValue(of(HEROES));
    fixture.detectChanges();

    // dig into template to find li elements - only one li element inside entire template.
