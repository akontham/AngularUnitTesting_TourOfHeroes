...
describe("Heroes Componet (deep test)", () => {
  ...
  it(`should add a new hero to the hero list when the add button is clicket`, () => {
    ...
    const addButton = fixture.debugElement.query(
      By.css('button[data-test="addButton"]')
    );

    fixture.debugElement.query(By.css("input")).nativeElement.vlaue = name; // this simulates typing Mr. Ice into the input element.
    fixture.debugElement
      .query(By.css('button[data-test="addButton"]'))
      .triggerEventHandler("click", null); // pass null to the event object as no $event is being triggered on the button.
