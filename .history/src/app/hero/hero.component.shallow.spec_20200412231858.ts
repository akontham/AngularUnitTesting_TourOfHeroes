  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      /*
        ...
        For ex: when an anchor element is changed to <za></za> from <a></a>, the above unit test will still pass. In an ideal scenario, your angular unit test will say element za was not found.
      */
