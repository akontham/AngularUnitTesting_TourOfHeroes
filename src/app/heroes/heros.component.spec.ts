...
describe("HerosComponent", () => {
  ...
  describe("delete", () => {
    ...
    it("should call deleteHero", () => {
      ...
      // Test which confirms if the deleteHero method was called.
      expect(mockHeroService.deleteHero).toHaveBeenCalled();

      // Test which confirms if the deleteHero was called with the correct parameter/valiue.
      expect(mockHeroService.deleteHero).toHaveBeenCalledWith(HEROES[2]);

      // Test which comfirms the delete heror is returning an observable and
      // we are subscribing to the result of the observable
